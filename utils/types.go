...
import (
	...
	"regexp"
	"strings"
	"uni-resolver-driver-did-cndid/utils/config"

	"uni-resolver-driver-did-cndid/utils/hexutil"
)
...
var (
	...
	AddressRegexp     = regexp.MustCompile(`^(did:cndid:(([a-z0-9]{4}):)?)?([zes][sft])([1-9a-km-zA-HJ-NP-Z]+)$`)
